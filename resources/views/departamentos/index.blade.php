...
@section('content')
    ...
    <section class="content">
        ...
        <div class="">
            ...
            <div class="box-header">
                ...
                <a href="{{ route('departamentos.create') }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                <div class="box-tools">
                    <div class="input-group" style="width:200px;">
                        {!! Form::model(Request::only(['name']),['route' => 'departamentos.index', 'method' => 'GET', 'class' => 'form-horizontal', 'role' => 'search']) !!}
                            ...
                            <table id="zero-config" class="table table-striped dt-table-hover display responsive nowrap"
                                ...
                                @foreach($departamentos as $departamento)
                                    <tr data-id="{{ $departamento->id  }}">
                                        ...
                                        <td>{{ date('d/m/y H:i', strtotime($departamento->created_at)) }}
                                            </td>
            ...
            <div class=" clearfix">
                <div class="row">
                    <div class="col-sm-5">
                        <div class="dataTables_info" role="status" aria-live="polite">{{ $departamentos->total() }} registros en total
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class=" ">
                            {!! $departamentos->appends(Request::only(['name']))->links('paginator') !!}
                        </div>
                    </div>
                </div>
            </div>
    ...
    {!! Form::open(['route' => ['departamentos.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
