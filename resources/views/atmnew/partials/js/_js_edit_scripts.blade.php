...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#date_init_contract').datepicker({
            language: 'es',
            format: 'dd/mm/yyyy',
        });

        $('#date_end_contract').datepicker({
            language: 'es',
            format: 'dd/mm/yyyy',
        });
        ...
        $('#nuevoAtm-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.post(form.action, $(form).serialize()).done(function(respuesta){
                    ...
                    // if(!$('#asignarAplicacion-form #group_atm_id').length){
                    //     $('<input>').attr({
                    //         type: 'hidden',
                    //         name: 'atm_id',
                    //         id: 'group_atm_id',
        ...
        $('#sucursalCaracteristicas-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $(form).find('input[descripcion="descripcion"]').prop('readonly', true)
                console.log("$(form).find('input[descripcion");
                console.log($(form).find('input[descripcion="descripcion"]').prop('readonly', true));
        ...
        // validacion del modal de nueva ciudad
        ...
        // validacion del modal de nuevo barrio
        ...
        $(document).on('select2:select','#departamento_id',function(){
            $.get("{{ route('atmnew.ciudades') }}", {departamento_id: $(this).val()}).done(function(response){
        ...
        $(document).on('select2:select','#ciudad_id',function(){
            $.get("{{ route('atmnew.barrios') }}", {ciudad_id: $(this).val()}).done(function(response){
        ...
        $(document).on('select2:select','#ciudad_id',function(){
            $.get("{{ route('atmnew.zonas') }}", {ciudad_id: $(this).val()}).done(function(response){
        ...
        // validacion del modal de nuevo tipo de contrato
        $('#nuevoContractType-form').validate({
            rules: {
                "description": {
                    required: true,
        ...
        //validacion formulario contrato
        ...
        $('#group_id').on('select2:select',function(){
          ...
          $('#nuevogrupo-form').attr('action',url.replace('0',$('#group_id').val())); //OJO
        ...
        ///////  PASO 2: AREAS DE LEGALES   ////////
        ///TAB 4 - POLIZAS
        // validacion del modal de nuevo tipo de póliza
        ...
        // validacion del modal de nuevo tipo de isp
        ...
        // validacion del modal de nuevo internet service contract
        ...
        // validacion del modal de nuevo tecnologia de red
        ...
        //validacion formulario NETWORK CONNECTION
        ...
        $('#asignarAplicacion-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.post(form.action, $(form).serialize()).done(function(respuesta){
                    ...
                    if (typeof respuesta.resumen.contrato_vigencia_ini != 'undefined') {
                        $('#contractDateInit').text(respuesta.resumen.contrato_vigencia_ini);
                    }

                    if (typeof respuesta.resumen.contrato_vigencia_end != 'undefined') {
                        $('#contractDateEnd').text(respuesta.resumen.contrato_vigencia_end);
                    }
        ...
        $(document).on('click','#btnOmitirCredendiciales', function(e){
            e.preventDefault();
            nextStep('#btnOmitirCredendiciales');
        });
        ...
        $(document).on('click','#btnOmitirAsignacion', function(e){
            e.preventDefault();
            nextStep('#btnAsociarContratoPoliza');
        });
        ...
        function nextStep(btnId) {
            ...
            if(btnId == '#btnAsociarContratoPoliza'){
        ...
        if(atmStatus == -2){
            $('button[href="#step-2"]').removeAttr('disabled').trigger('click');
        }
        if(atmStatus == -4){
            $('button[href="#step-3"]').removeAttr('disabled').trigger('click');
        }
        if(atmStatus == -5){
            $('button[href="#step-4"]').removeAttr('disabled').trigger('click');
        }
        if(atmStatus == -6){
            $('button[href="#step-5"]').removeAttr('disabled').trigger('click');
        }
