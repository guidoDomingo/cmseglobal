    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                <a href="{{ route('parametros_comisiones.create') }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                <div class="box-tools">
            ...
            <div class="clearfix">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="">
                            {!! $parametros_comisiones->appends(Request::only(['name']))->links('paginator') !!}
                        </div>
                    </div>
                </div>
            </div>
