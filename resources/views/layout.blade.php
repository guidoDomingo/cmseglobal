...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        @yield('content')
        <a id="back-to-top" href="#" class="btn bg-orange btn-lg back-to-top" role="button" title="Volver arriba" data-toggle="tooltip" data-placement="left"><span class="glyphicon glyphicon-chevron-up"></span></a>
    </div><!-- /.content-wrapper -->
    <!-- Main Footer -->
