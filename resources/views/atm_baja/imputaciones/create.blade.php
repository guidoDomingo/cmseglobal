...
@section('content')
    ...
    <section class="content-header">
        <h1>
            GESTIÓN ASEGURADORA |
            <small>Registrar Imputación de deudas</small>
        </h1>
        <ol class="breadcrumb">
...
<script type="text/javascript">
    ...
    $('#fecha_cobro').datepicker("setDate", new Date());

    $('#fecha_siniestro').datepicker({
        language: 'es',
        format: 'dd/mm/yyyy',
    });
    $('#fecha_siniestro').datepicker("setDate", new Date());

    //validacion formulario 
    $('#nuevaImputacion-form').validate({
        rules: {
            "numero": {
                required: true,
            },
