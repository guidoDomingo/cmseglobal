...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Baja</a></li>
            <li class="active">Compromiso de pago</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered table-hover dataTable" role="grid" id="datatable_compromisos" style="font-size: 13px">
                                    <thead>
                                        <tr>
                                            <th style="width:10px; text-align:center;">#</th>
                                            <th style="text-align:center;">Número</th>
                                            <th style="text-align:center;">Estado el compromiso</th>
                                            <th style="text-align:center;">Cantidad de pagos</th>
                                            <th style="text-align:center;">Monto</th>
                                            <th style="text-align:center;">Fecha de compromiso</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-id="{{ $item->id }}">
                                                ...
                                                <td style="text-align:center; vertical-align:middle;">{{ $item->cantidad_pago }}</td>
                                                ...
                                                <td style="vertical-align:middle; text-align:center;">
                                                    @if (Sentinel::hasAccess('atms.group.compromiso.edit'))
                                                        <a class="btn btn-success btn-flat btn-row btn-sm" title="Editar" href="{{ route('compromisos.edit',['id' => $item->id])}}"><i class="fa fa-pencil"></i></a>
                                                    @endif
                                                    @if (Sentinel::hasAccess('atms.group.compromiso.delete'))
    ...
    {!! Form::open(['route' => ['compromisos.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
...
<script type="text/javascript">            
    ...
    $('#datatable_compromisos').DataTable(data_table_config);
</script>
