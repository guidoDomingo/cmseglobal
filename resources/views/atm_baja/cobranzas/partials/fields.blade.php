<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('group_id', $grupos, null, ['id' => 'group_id', 'class' => 'form-control select2', 'placeholder' => 'Seleccione una opción', 'required' => 'true']) !!}
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::number('boleta_numero', null, ['id' => 'boleta_numero', 'class' => 'form-control', 'placeholder' => 'Ingrese el número', 'required' => 'true']) !!}
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('cuenta_bancaria_id_aux', $cuentas, null, ['id' => 'cuenta_bancaria_id_aux', 'class' => 'form-control select2', 'placeholder' => 'Seleccione una opción', 'required' => 'true']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <small> (Sin ceros a la izquierda. Modo correcto: 50000. Modo incorrecto: 00050000) </small>
            {!! Form::number('monto', null, ['id' => 'monto', 'class' => 'form-control', 'placeholder' => 'Monto', 'required' => 'true']) !!}
        </div>
    </div>
</div>
