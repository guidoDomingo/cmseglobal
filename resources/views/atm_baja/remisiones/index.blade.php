...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Baja</a></li>
            <li class="active">Remisión de Pagaré</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        @if (Sentinel::hasAccess('atms.group.remision.pagare.add'))

                        <a href="{{ route('remisiones.create',['atm_list' => $atm_ids, 'group_id' => $grupo->id]) }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                        @endif
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered table-hover dataTable" role="grid" id="datatable_remisiones" style="font-size: 13px">
                                    <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-id="{{ $item->id }}">
                                                ...
                                                <td style="text-align:center; vertical-align:middle;">{{ $item->nro_contrato }}</td>
                                                <td style="vertical-align:middle; text-align:center;">{{ date('d/m/Y', strtotime($item->fecha)) }}</td>
                                                <td style="vertical-align:middle;  text-align:center;">{{ number_format($item->importe) }}</td>
                                                <td style="vertical-align:middle; text-align:center;">
                                                    @if (Sentinel::hasAccess('atms.group.remision.pagare.edit'))
                                                        <a class="btn btn-success btn-flat btn-row btn-sm" title="Editar" href="{{ route('remisiones.edit',['id' => $item->id])}}"><i class="fa fa-pencil"></i></a>
                                                    @endif
                                                    @if (Sentinel::hasAccess('atms.group.remision.pagare.delete'))
    ...
    {!! Form::open(['route' => ['remisiones.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
...
<script type="text/javascript">            
    ...
    $('#datatable_remisiones').DataTable(data_table_config);
</script>
