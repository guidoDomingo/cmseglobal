...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Baja</a></li>
            <li class="active">Recibo de ganancia</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        @if (Sentinel::hasAccess('atms.group.recibo.ganancia.add'))
                            <a href="{{ route('recibos_ganancia.create',['atm_list' => $atm_ids, 'group_id' => $grupo->id]) }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                        @endif
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered table-hover dataTable" role="grid" id="datatable_ganancia" style="font-size: 13px">
                                    <thead>
                                        <tr>
                                            <th style="width:10px; text-align:center;">#</th>
                                            <th style="text-align:center;">Número interno</th>
                                            <th style="text-align:center;">Fecha de finiquito</th>
                                            <th style="text-align:center;">Importe cobrado</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-id="{{ $item->id }}">
                                                ...
                                                <td style="vertical-align:middle;  text-align:center;">{{ number_format($item->importe_cobrado) }}</td>
                                                <td style="vertical-align:middle;  text-align:center;">{{ number_format($item->capital) }}</td>
                                                <td style="vertical-align:middle; text-align:center;">
                                                    @if (Sentinel::hasAccess('atms.group.recibo.ganancia.edit'))
                                                        <a class="btn btn-success btn-flat btn-row btn-sm" title="Editar" href="{{ route('recibos_ganancia.edit',['id' => $item->id])}}"><i class="fa fa-pencil"></i></a>
                                                    @endif
                                                    @if (Sentinel::hasAccess('atms.group.recibo.ganancia.delete'))
    ...
    {!! Form::open(['route' => ['recibos_ganancia.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
...
<script type="text/javascript">            
    ...
    $('#datatable_ganancia').DataTable(data_table_config);
</script>
