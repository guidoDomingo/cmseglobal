...
@section('content')
    <section class="content-header">
        <h1>
            NOTA DE RETIRO
            <small>Generar nota de retiro</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Gestor de terminales</a></li>
            <li><a href="#">Baja</a></li>
            <li class="active">Nota de retiro</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered table-hover dataTable" role="grid" id="datatable_retiro" style="font-size: 13px">
                                    <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-id="{{ $item->id }}">
                                                ...
                                                {{-- <td style="text-align:center; vertical-align:middle;">{{ $item->atm }}</td> --}}
                                                ...
                                                <td style="vertical-align:middle; text-align:center;">
                                                    ...
                                                    <a href="{{ route('notaretiro.show',['id' => $item->id])}}" class="btn btn-primary btn-flat btn-row btn-sm" title="Visualizar CORREO"><i class="fa fa-envelope-o"></i></a>

                                                    @if (Sentinel::hasAccess('atms.group.nota.preview_pdf.pdf'))
                                                        <a href="{{ route('notaretiro.preview_pdf',['id' => $item->id])}}" class="btn btn-info btn-flat btn-row btn-sm" title="Visualizar PDF"><i class="fa fa-eye"></i></a>
                                                    @endcan
                                                    @if (Sentinel::hasAccess('atms.group.nota.retiro.pdf'))
                                                        <a href="{{ route('notaretiro.pdf',['id' => $item->id])}}" class="btn btn-warning btn-flat btn-row btn-sm" title="PDF"><i class="fa fa-file-pdf-o"></i></a>
                                                    @endcan
                                                    @if (Sentinel::hasAccess('atms.group.nota.retiro.edit'))
                                                        <a class="btn btn-success btn-flat btn-row btn-sm" title="Editar" href="{{ route('notaretiro.edit',['id' => $item->id])}}"><i class="fa fa-pencil"></i></a>
                                                    @endif
                                                    @if (Sentinel::hasAccess('atms.group.nota.retiro.delete'))
    ...
    {!! Form::open(['route' => ['notaretiro.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
@endsection
...
<script type="text/javascript">            
    ...
    $('#datatable_retiro').DataTable(data_table_config);
</script>
