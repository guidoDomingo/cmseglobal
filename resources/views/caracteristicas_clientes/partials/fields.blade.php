            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('banco_id',$bancos ,$banco_id , ['class' => 'select2', 'placeholder' => 'Seleccione una opción' , 'style' => 'width:50%']) !!}
                    </div> 
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('tipo_cuenta',$tipo_cuentas, $tipo_cuentas_id , ['class' => 'select2', 'placeholder' => 'Seleccione una opción' , 'style' => 'width:50%' ]) !!}
                    </div> 
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('canal_id',$canales ,$canal_id , ['class' => 'select2', 'placeholder' => 'Seleccione una opción' , 'style' => 'width:50%']) !!}
                    </div> 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('categoria_id',$categorias ,$categoria_id , ['class' => 'select2', 'placeholder' => 'Seleccione una opción' , 'style' => 'width:50%']) !!}
                    </div> 
                </div>
            </div>
