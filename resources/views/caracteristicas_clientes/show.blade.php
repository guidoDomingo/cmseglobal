        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                @if (Sentinel::hasAccess('caracteristicas_clientes.add'))
                    <a href="{{ route('caracteristicas.clientes.create',['caracteristica' => $group_id]) }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                @endif
                <a class="btn btn-danger mb-2 me-4" href="{{ route('caracteristicas.clientes.index',['caracteristica' => $group_id]) }}" role="button">Cancelar</a>
