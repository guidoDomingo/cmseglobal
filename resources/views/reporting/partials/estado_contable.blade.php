    ...
    <div class="row">
        <div class="col-md-12">
            <div class=" box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.estado_contable.search')}}" method="GET" id="estadoContable-form">
                    <div class="box-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    {!! Form::label('atm', 'ATM') !!}
                                    {!! Form::select('atm_id', $data_select, $atm_id, ['id' => 'atm_id','class' => 'form-control select2', 'placeholder' => 'Seleccione el atm']) !!}
                                </div>
                ...
                <div class="box box-primary">
                            ...
                            <div class="col-sm-12">
                                ...
                                style="width:100%">
                                    ...
                                    @foreach($transactions as $transaction)
                                        @if($transaction->concepto == 'Balance Anterior')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                        <div class="description-block border-right">
                                            {{-- <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 17%</span> --}}
                                            <h2 class="description-header">{{ $total_pago_qr }}</h2>
                    ...
                    <div class=" clearfix">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class=" ">
                                    {!! $transactions->appends(['reservationtime' => $reservationtime, 'atm_id' => $atm_id])->links('paginator') !!}
                                </div>
                            </div>
                        </div>
                    </div>
