    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.sales_old.search')}}" method="GET">
                            ...
                            @elseif( !\Sentinel::getUser()->inRole('mini_terminal') && !\Sentinel::getUser()->inRole('supervisor_miniterminal'))
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('mostrar', ['todos' => 'Todos', 'transacciones' => 'Transacciones', 'paquetigos' => 'Paquetigos', 'personal' => 'Personal', 'claro' => 'Claro', 'cashouts' => 'Pago de Cashouts'], $mostrar, ['id' => 'traer','class' => 'form-control select2']) !!}
                                    </div>
                                </div>
                                <!-- /.col -->
                                <div class="col-md-6">
