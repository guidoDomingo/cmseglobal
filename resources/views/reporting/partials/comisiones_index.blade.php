    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.comisiones.search')}}" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('user_id', $users, $user_id, ['id' => 'user_id','class' => 'form-control select2', 'placeholder' => 'Seleccione el usuario']) !!}
                                </div>
                                <!-- /.form-group -->
                ...
                <div class="box-primary">
                            ...
                            <div class="col-sm-12">
                                ...
                                style="width:100%">
                                    ...
                                    <tr>
                                        <th width="25%">ATM</th>
                                        <th width="30%">Tipo</th>
                                        <th width="12%">Valor Transacción</th>
                                        <th width="12%">Comisión</th>
                                    ...
                                    @foreach($transactions as $transaction)
                                        <tr>
                                            <td>{{ $transaction->atm }}</td>
                                            <td> {{--@if($transaction->provider == 'Infonet') IC  @else {{ $transaction->provider }} @endif - --}}{{ $transaction->servicio }}</td>
                                            <td align="right">{{ number_format($transaction->monto_total, 0, '.', ',') }}</td>
                                            <td align="right">{{ number_format($transaction->monto_total*$transaction->comision/100, 2, '.', ',') }}</td>
                                            @if ($transaction->service_id==7 && $transaction->service_source_id==0)
                                                <td align="right">{{ number_format(0.75, 2, '.', ',') }}%</td>
                                            @else
                                                <td align="right">{{ number_format($transaction->comision, 2, '.', ',') }}%</td>
                                            @endif
                                        </tr>
                                    @endforeach
                                    </tbody>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="description-block border-right">
                                            ...
                                            <h2 class="description-header">{{ number_format($total_transacciones, 0, '.', ',') }}</h2>
                                            <span class="description-text">TOTAL TRANSACCIONADO</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="description-block border-right">
                                            {{-- <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 17%</span> --}}
                                            <h2 class="description-header">{{ number_format($total_comisiones, 2, '.', ',') }}</h2>
                                            <span class="description-text">TOTAL COMISIONES</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class=" clearfix">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class=" ">
                                    {!! $transactions->appends(['user_id' => $user_id, 'reservationtime' => $reservationtime])->links('paginator') !!}
                                </div>
                            </div>
                        </div>
                    </div>
