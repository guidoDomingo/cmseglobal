    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.resumen_detallado_miniterminal_old.search')}}" method="GET" id="estadoContable-form">
                    ...
                    <div class="box-tools">
                        <div class="input-group" style="width:200px; float:right; padding-right:10px">
                            {!! Form::model(Request::only(['context']),['route' => 'reporting.resumen_detallado_miniterminal_old.search', 'method' => 'GET', 'class' => 'form-horizontal', 'role' => 'search']) !!}
    ...
    <script>
        $(function(){
            ...
            $('.pay-info').on('click',function(e){
                ...
                $.get('{{ url('reports') }}/info/get_branch_groups_old/' + group_id + '/' + day, 
            ...
            $('.info-reversiones').on('click',function(e){
                ...
                $.get('{{ url('reports') }}/info/get_reversions_groups_old/' + group_id + '/' + day, 
            ...
            $('.info-cashouts').on('click',function(e){
                ...
                $.get('{{ url('reports') }}/info/get_cashouts_groups_old/' + group_id + '/' + day, 
