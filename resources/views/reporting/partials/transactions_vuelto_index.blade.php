    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reports.transactions_vuelto.search')}}" method="GET">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <button id="saveButton" type="submit" class="btn btn-block btn-primary" name="search" value="search" id="buscar">BUSCAR</button>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                style="width:100%">
                                    <thead>
                                    <tr>
                                        <th style="min-width:110px;">ID. Transacción</th>
                                        <th>Tipo</th>
                                        <th>Estado</th>
                                        <th>Fecha</th>
                                        ...
                                        <th>Sede</th>
                                        <th>Codigo Cajero</th>
                                        {{-- <th>Vuelto Esperado</th>
                                        <th>Vuelto Obtenido</th> --}}
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($transactions as $transaction)
                                        <tr  data-id="{{ $transaction->id  }}" data-description="{{ $transaction->provider }} - {{ $transaction->servicio }}" data-amount="{{number_format($transaction->amount,0)}}" data-ref1="{{$transaction->referencia_numero_1}}" data-ref2="{{$transaction->referencia_numero_2}}"  data-estado="{{ $transaction->estado  }}" data-payid="{{ $transaction->cod_pago  }}" data-status="{{$transaction->status_description}}"  data-transaction="{{ $transaction->atm_transaction_id }}">
                                            ...
                                            <td>{{ number_format($transaction->vuelto_no_entregado,0) }}</td>
                                            <td>{{ $transaction->sede }}</td>
                                            <td align="right">{{ $transaction->code }}</td>
                                            {{-- <td align="right">{{ $transaction->vuelto }}</td>
                                            <td align="right">{{ $transaction->valor_entregado }}</td> --}}
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class=" clearfix">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="dataTables_info" role="status" aria-live="polite">Total Monto de transacciones: <b>{{ number_format($total_transaction->monto, 0) }}</b> <i class="fa fa-money"></i> </td></div>
                                @endforeach
                            </div>
                            <div class="col-sm-3">
                                @foreach($total_transactions as $total_transaction)
                                <div class="dataTables_info" role="status" aria-live="polite">Total Vuelto no Entregado: <b>{{ number_format($total_transaction->vuelto_no_entregado, 0) }}</b> <i class="fa fa-money"></i> </td></div>
                                @endforeach
                            </div>
                        </div>
                        <div class="row">
