    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reports.cargas.search')}}" method="GET">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="input-group" style="width:150px;">
                            {!! Form::model(Request::only(['context']),['route' => 'reports.cargas.search', 'method' => 'GET', 'class' => 'form-horizontal', 'role' => 'search']) !!}
