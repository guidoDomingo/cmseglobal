    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.depositos_alquileres.search')}}" method="GET" id="estadoContable-form">
                                        ...
                                        <tr data-id="{{ $transaction->id  }}">
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-default btn-xs btn-row"  href="{{route('reporting.boleta_alquiler.comprobante',$transaction->id)}}">
    ...
    <script>
        $(function(){
            ...
            $('.info').on('click',function(e){
                ...
                $.get('{{ url('reports') }}/info/details_alquiler/' + id, function(data) {
