    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-default">
                ...
                <!-- /.box-header -->
                <form action="{{route('reporting.cobranzas.search')}}" method="GET">
                        ...
                        <div class="row">
                            @if(\Sentinel::getUser()->inRole('supervisor_miniterminal'))
                                <div class="col-md-6">
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        {!! Form::label('receipt_type', 'Tipo de Recibo') !!}
                                        {!! Form::select('receipt_type', $receipts_types, $receipt_type, ['class' => 'form-control select2', 'placeholder' => 'Seleccione un tipo de recibo']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <!-- Date and time range -->
                            ...
                            <div class="col-sm-12">
                                ...
                                style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th>Nro Recibo</th>
                                        <th>Monto</th>
                                        <th style="width:20%">Tipo de Recibo</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($transactions as $transaction)
                                        <tr data-id="{{ $transaction->id  }}">
                                            ...
                                            <td>{{ $transaction->recibo_nro }}</td>
                                            <td>{{ number_format(abs($transaction->amount), 0, '.', ',') }}</td>
                                            <td style="width:20%">{{ $transaction->tipo_recibo }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="row">
                                <div style="text-align: center;">
                                    <div class="description-block">
                                        ...
                                        <h2 class="description-header">{{ number_format(abs(array_sum(array_column($transactions, 'amount'))), 0, '.', ',') }}</h2>
                                        <span class="description-text">TOTAL MONTO</span>
                                    </div>
                                </div>
                            </div>
                        </div>
