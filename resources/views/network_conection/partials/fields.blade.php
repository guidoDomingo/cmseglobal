...
@else --}}
    ...
    <div class="col-md-6">
        <div class="mb-3">
            {!! Form::label('internet_service_contract_id', 'Contrato de servicio de internet') !!}
            <a class="ms-5" href='#' id="nuevoInternetServiceContract" data-bs-toggle="modal" data-bs-target="#modalNuevoInternetServiceContract"><small>Agregar <i class="fa fa-plus"></i></small></a>
            <div class="input-group">
                <span class="input-group-text"><i class="fa fa-filter"></i></span>
                {!! Form::select('internet_service_contract_id', $internet_service_contracts, null, ['id' => 'internet_service_contract_id','class' => 'select2', 'style' => 'width: 50%','placeholder'=>'Seleccione un tipo de contrato...']) !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            {!! Form::label('network_technology_id', 'Tecnología de Red') !!}
            @if (\Sentinel::getUser()->inRole('superuser'))
                <a class="ms-5" href='#' id="nuevoNetworkTechnology" data-bs-toggle="modal" data-bs-target="#modalNuevoNetworkTechnology"><small>Agregar <i class="fa fa-plus"></i></small></a>
            @endif
            <div class="input-group">
                <span class="input-group-text"><i class="fa fa-filter"></i></span>
                {!! Form::select('network_technology_id', $network_technologies, null, ['id' => 'network_technology_id','class' => 'select2', 'style' => 'width: 50%','placeholder'=>'Seleccione una tecnologia de red...']) !!}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                {!! Form::text('installation_date', null, [ 'class' => 'form-control', 'placeholder' => 'Ingrese la fecha de instalación']) !!}
            </div>
        </div>
    </div>
</div>
    ...
    @if(isset($housing_id))
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="fa fa-filter"></i></span>
                    {!! Form::select('housing_id', $housings, null,['class' => 'select2','disabled' => 'disabled']) !!}
                </div>
            </div>
        </div>
    @else
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="fa fa-filter"></i></span>
                    {!! Form::select('housing_id', $housings, null,[ 'id' => 'housing_id', 'class' => 'select2','style' => 'width: 50%','placeholder'=>'Seleccione una tecnologia de red...']) !!}
                </div>
            </div>
        </div>
    @endif
