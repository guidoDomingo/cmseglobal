...
@if(isset($wsproviders))
  ...
  {!! Form::select('service_provider_id',$wsproviders ,null , ['class' => 'form-control ','placeholder' => 'Seleccione un Proveedor...']) !!}
@endif
</div>
<div class="form-group">
	@if(isset($app_categories))
		{!! Form::label('app_categories', 'Categoría') !!}
		{!! Form::select('app_categories_id',$app_categories ,null , ['class' => 'form-control ','placeholder' => 'Seleccione una Categoría ...']) !!}
	@endif
</div>
<div class="form-group">
