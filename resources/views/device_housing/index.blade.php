    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{ route('miniterminales.create') }}" class="btn btn-primary mb-2 me-4" role="button">Agregar Housing</a>
                 <div class="box-tools">
            ...
            <div class=" clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class=" ">
                            {!! $miniterminales->appends(Request::only(['name']))->links('paginator') !!}
                        </div>
                    </div>
                </div>
            </div>
