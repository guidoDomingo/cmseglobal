    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                {{-- <a href="{{ route('tickets.create') }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a> --}}
                <a class="btn-sm btn-default" href="{{ route('campaigns.index') }}" role="button">Atrás</a>
                <a href="{{ route('tickets.create',['campaign_id' => $campaign_id]) }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                <div class="box-tools">
