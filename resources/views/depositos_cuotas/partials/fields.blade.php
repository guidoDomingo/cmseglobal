...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <small> (Sin ceros a la izquierda y que sea la TOTALIDAD de la cuota. Modo correcto: 650000. Modo incorrecto: 000650000) </small>
...
<div class="cuota" style="display: none">
    ...
    {{--{!! Form::label('cuota_numero', $cuota->numero_cuota, ['id' => 'cuota_numero', 'name' => 'cuota_numero']) !!}--}}
</div>
