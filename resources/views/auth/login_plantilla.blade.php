                ...
                <div class="col-6 d-lg-flex d-none h-100 my-auto top-0 start-0 text-center justify-content-center flex-column">
                    ...
                    <div class="auth-cover">
                        ...
                        <div class="position-relative">
                            ...
                            <img src="{{ asset('img/eglobal3.jpg') }}" alt="auth-img">
    
                            <h2 class="mt-5 text-white font-weight-bolder px-2">Terminales inteligentes</h2>
                            <p class="text-white px-2">@EGLOBAL S.A</p>
                        </div>
