...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Conciliador de boletas</a></li>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document"
                    ...
                    <div class="modal-footer">
                        <div class="btn-group mr-2" role="group">
                            {!! Form::open(['route' => 'ballot_conciliator_cancel', 'method' => 'POST', 'role' => 'form', 'id' => 'ballot_conciliator_form_cancel']) !!}
                        ...
                        <div class="btn-group mr-2" role="group">
                            {!! Form::open(['route' => 'ballot_conciliator_store', 'method' => 'POST', 'role' => 'form', 'id' => 'ballot_conciliator_form_store']) !!}
