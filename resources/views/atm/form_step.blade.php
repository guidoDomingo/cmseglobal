            ...
            <div class="col-md-12">
                <div class="box-primary setup-content" id="step-1">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::open(['route' => 'atm.store' , 'method' => 'POST', 'role' => 'form', 'id' => 'nuevoAtm-form']) !!}
                ...
                <div class="box box-primary setup-content" id="step-2">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Nuevo Punto de Venta - <span id='labelRed'></span></h3>
                    </div>
                    <div class="box-body">
                        @include('partials._messages')
                ...
                <div class="box box-primary setup-content" id="step-3">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Nuevo Comprobante - PDV <span id='labelPdv'></span></h3>
                    </div>
                    <div class="box-body">
                        @include('partials._messages')
                ...
                <div class="box-primary setup-content" id="step-4">
                    ...
                    <div class="box-body">
                        @include('partials._messages')
                        <div id='grupo'>
                                {!! Form::open(['route' => ['groups.update_branch', 0] , 'method' => 'PUT', 'role' => 'form', 'id' => 'nuevogrupo-form']) !!}
                                @include('groups.partials.step_fields_5')
                                {!! Form::close() !!}
                        </div>
                        {!! Form::open(['route' => ['applications.assign_atm', 0 ] , 'method' => 'POST', 'role' => 'form', 'id' => 'asignarAplicacion-form']) !!}
 ...
 {{-- FIN SELECT  --}}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            // validacion del modal de nuevo departamento
            $('#nuevaDepartamento-form').validate({
                        rules: {
                            "descripcion": {
                                required: true,
                            },
                        ...
                        submitHandler: function(form) {
                            $('#btnGuardarDepartamento').toggleClass('active');
                            $(form).find('input[type="text"]').prop('readonly',true);
                            $(form).find('input[type="select"]').prop('readonly',true);
                            $.post(form.action, $(form).serialize()).done(function(respuesta){
                                $('#btnGuardarDepartamento').toggleClass('active');
                                ...
                                $('#modalNuevaDepartamento').modal('hide');
                                var newOption = new Option(respuesta.data.description, respuesta.data.id, false, true);
                                $('#branch_id').append(newOption).trigger('change');
                            });
                        }
