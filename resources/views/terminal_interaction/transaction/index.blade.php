...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Transacciones - Reporte</a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        {!! Form::open(['route' => 'transaction_index', 'method' => 'POST', 'role' => 'form', 'id' => 'form_search']) !!}
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <tbody>
                                    ...
                                    @for ($i = 0; $i < count($list); $i++)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="label label-{{ $label_class }}">{{ $item['status'] }}</span>
                                            </td>
                                        </tr>
                                    @endfor
                                </tbody>
