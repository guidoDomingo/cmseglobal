  ...
  <div class="box">
    ...
    <div class="box-header">
      <h3 class="box-title">
        ...
        <a href="{{ route('owner.branches.create',['owner' => $ownerId]) }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
      <div class="box-tools">
...
<div class="box-footer clearfix">
 <div class="row">
  ...
  <div class="col-md-12">
    <div class="">
      {!! $branches->appends(Request::only(['name']))->links('paginator') !!}
    </div>
  </div>
</div>
</div>
