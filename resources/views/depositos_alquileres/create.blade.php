...
@section('content')
    <section class="content-header">
        <h1>
            ...
            <small>Registro de deposito de Alquiler</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Deposito de Alquiler</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nuevo Deposito de Alquiler</h3>
                    </div>
                    <div class="box-body">
                        @include('partials._messages')
                        {!! Form::open(['route' => 'depositos_alquileres.store' , 'method' => 'POST', 'role' => 'form']) !!}
                        @include('depositos_alquileres.partials.fields')
                    </div>
                    <div class="box-footer">
                        <a class="btn btn-default" href="{{ route('depositos_alquileres.index') }}" role="button">Cancelar</a>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('#monto').on('change keydown paste input',function(){
            ...
            $.get("/get_cuotas_alquiler/" + atm_id, function(data) {
                ...
                if(Number.isInteger(cuotas)){
                    if(cuotas == 1 ){
                        ...
                        $('#cant_cuotas').text("El monto debe ser exactamente la cantidad de una cuota.");
                    }
                }else{
                    document.getElementById("guardar").disabled = true;
