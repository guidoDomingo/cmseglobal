@extends('app')
@section('title')
    Deposito de Cuotas de Alquiler
@endsection
...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Deposito de Cuotas de Alquiler</a></li>
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header">
                ...
                <a href="{{ route('depositos_alquileres.create') }}" class="btn btn-primary mb-2 me-4" role="button">Agregar</a>
                <div class="box-tools">
                    <div class="input-group" style="width:150px;">
                        {!! Form::model(Request::only(['name']),['route' => 'depositos_alquileres.index', 'method' => 'GET', 'class' => 'form-horizontal', 'role' => 'search']) !!}
                            ...
                            <tbody>
                                @if (\Sentinel::getUser()->hasAccess('depositos_cuotas') && !\Sentinel::getUser()->hasAccess('superuser') && !\Sentinel::getUser()->hasRole('mantenimiento.operativo') && !\Sentinel::getUser()->hasRole('accounting.admin'))    
                                    @foreach($depositocuotas as $depositoboleta)
                                        @if ($depositoboleta->estado == null && $depositoboleta->tipo_recibo_id == 2)
    ...
    {!! Form::open(['route' => ['depositos_alquileres.destroy',':ROW_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
    {!! Form::close() !!}
...
<script type="text/javascript">
    $('.btn-migrate').click(function(e){
        ...
        function(isConfirm){
            if (isConfirm) {
                var url = '/reports/depositos_alquileres/migrate';
                var type = "";
                var title = "";
    ...
    $('.btn-delete').click(function(e){
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                var url = '/reports/depositos_alquileres/delete';
                var type = "";
                var title = "";
