        ...
        <div class="box">
            <div class="box-header">
                ...
                @if (Sentinel::hasAccess('categorias.add|edit'))
                    <a href="{{ route('categorias.create') }}" class="btn-sm btn-primary active" role="button">Agregar</a>
                @endif
            </div>
            <div class="box-body">
                <div class="row">
                                ...
                                @foreach($categorias as $item)
                                    <tr data-id="{{ $item->id  }}">
                                        ...
                                        <td style="text-align:center; vertical-align:middle;">
                                            @if (Sentinel::hasAccess('categorias.add|edit'))
                                                <a class="btn btn-success btn-flat btn-row" title="Editar" href="{{ route('categorias.edit',['id' => $item->id])}}"><i class="fa fa-pencil"></i></a>
                                            @endif
